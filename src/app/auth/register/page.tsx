    ...
    <div className="min-h-[calc(100vh-7rem)] flex flex-col lg:flex-row">
      ...
      <div className="lg:hidden relative overflow-hidden bg-gradient-to-br from-primary via-blue-600 to-indigo-700 px-5 py-5">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-xl font-bold text-white leading-tight mb-1">Pridružite se Easy Go porodici</h2>
          <p className="text-white/50 text-xs">Kreirajte račun i otkrijte sve pogodnosti kupovine.</p>
