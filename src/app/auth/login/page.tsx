    ...
    <div className="min-h-[calc(100vh-5rem)] flex flex-col px-4 py-6 lg:py-10">
      <div className="flex-1 flex flex-col justify-center w-full max-w-[420px] mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl lg:text-3xl font-bold text-text">Dobrodošli nazad</h1>
          <p className="text-muted mt-1.5 text-sm">Prijavite se za nastavak kupovine</p>
        </div>
          ...
          <div className="bg-surface rounded-2xl p-6 border border-white/[0.06] shadow-xl shadow-black/10">
            {resetSent ? (
              <div className="text-center py-4">
                ...
                <h3 className="text-lg font-semibold text-text mb-2">Email poslan!</h3>
                <p className="text-sm text-muted mb-5 max-w-[260px] mx-auto">Provjerite inbox za link za resetovanje lozinke.</p>
                <button
              ...
              <form onSubmit={handleResetPassword} className="space-y-4">
                <div className="text-center mb-2">
                  ...
                  <h3 className="text-lg font-semibold text-text">Resetuj lozinku</h3>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-background border border-white/10 rounded-xl py-3.5 pl-12 pr-4 text-text placeholder:text-muted focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-all"
                    required
                  />
                </div>
                <div className="flex gap-3 pt-1">
                  <button
                    ...
                    className="flex-1 border border-white/10 text-text py-3 rounded-xl font-medium hover:bg-white/5 transition-colors"
                  >
                    Nazad
                  </button>
                  <button
                    type="submit"
                    className="flex-1 bg-primary text-white py-3 rounded-xl font-semibold hover:bg-primary/90 transition-all hover:shadow-lg hover:shadow-primary/25"
                  >
                    Pošalji link
                  </button>
                </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-background border border-white/10 rounded-xl py-3.5 pl-11 pr-12 text-text text-sm placeholder:text-muted/40 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-all"
                      required
        ...
        <div className="flex items-center justify-center gap-1.5 mt-6 text-muted/60">
          ...
          <span className="text-[11px]">Sigurna i zaštićena prijava</span>
        </div>
      </div>
