      ...
      <div className="min-h-screen bg-background pb-8">
        ...
        <div className="px-4 py-12 lg:px-8 lg:max-w-2xl lg:mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="/" className="flex-1 bg-primary hover:bg-primary/90 text-white py-3 px-6 rounded-xl font-medium transition-colors text-center">
              Nastavi kupovinu
            </Link>
            <Link href={`/product/${product.slug || productId}`} className="flex-1 bg-surface hover:bg-white/5 text-text py-3 px-6 rounded-xl font-medium transition-colors border border-white/10 text-center">
              Nazad na proizvod
            </Link>
          </div>
        </div>
